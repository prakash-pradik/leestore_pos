                        ...
                        <div class="row" style="margin:0px;">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select id="" name="product_store" class="form-control">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="product_name" name="product_name" class="form-control" placeholder="Name.." value="<?php echo $product->product_name; ?>">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="imei_number1" name="imei_number1" class="form-control" placeholder="IMEI 1.." maxlength="16" value="<?php echo $product->imei_number1; ?>">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="control-label">IMEI Number 2</label>
                                    <input type="text" id="imei_number2" name="imei_number2" class="form-control" placeholder="IMEI 2.." maxlength="16" value="<?php echo $product->imei_number2; ?>">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="control-label">Serial Number</label>
                                    <input type="text" id="serial_number" name="serial_number" class="form-control" placeholder="Serial #.." value="<?php echo $product->serial_number; ?>">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="file" id="product_image" name="product_image" value="<?php echo $product->image; ?>">
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="price" name="price" class="form-control numeric" placeholder="" maxlength="7" value="<?php echo $product->price; ?>">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="control-label">Cost Price <span class="text-danger">*</span></label>
                                <input type="text" id="cost_price" name="cost_price" class="form-control numeric" placeholder="" maxlength="7" value="<?php echo $product->cost_price; ?>">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="control-label">Selling Price <span class="text-danger">*</span></label>
                                <input type="text" id="sell_price" name="sell_price" class="form-control numeric" placeholder="" maxlength="7" value="<?php echo $product->sell_price; ?>">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
